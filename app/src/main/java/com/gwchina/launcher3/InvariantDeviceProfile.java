...
public class InvariantDeviceProfile {
    ...
    // disable all apps mode
    public boolean isDisableAllApps = LauncherSettings.Settings.isDrawerDisable;
    ...
    ArrayList<InvariantDeviceProfile> getPredefinedDeviceProfiles() {
        ...
        predefinedDeviceProfiles.add(new InvariantDeviceProfile("Nexus 5",
                335, 567,     4, 4, 3, 3, 4, DEFAULT_ICON_SIZE_DP, 13, isDisableAllApps ? 4 : 5, isDisableAllApps ? DEFAULT_ICON_SIZE_DP : 56,
                R.xml.default_workspace_4x4));
        predefinedDeviceProfiles.add(new InvariantDeviceProfile("Large Phone",
                406, 694,     4, 4, 3, 3, 4, 64, 14.4f,  isDisableAllApps ? 4 : 5, isDisableAllApps ? DEFAULT_ICON_SIZE_DP : 56,
...
//                1527, 2527,   7, 7, 6, 6, 4, 100, 20,  7, 72, R.xml.default_workspace_5x6));
        ...
        // 小格雷定制机
//        predefinedDeviceProfiles.add(new InvariantDeviceProfile("greenbox",
//                720, 1280,    5, 4, 3, 3, 4, 76, 14.4f,  7, 76, R.xml.default_workspace_4x4));
