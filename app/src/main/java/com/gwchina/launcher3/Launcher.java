...
import com.gwchina.PageViewAnimation;
import com.gwchina.launcher3.util.AppAuditHelper;
import com.gwchina.launcher3.util.PermissionChecker;
import com.gwchina.theme.ThemeManager;
import com.gwchina.wallpaper.WallpaperPickerActivity;
import com.gwchina.launcher3.DropTarget.DragObject;
import com.gwchina.launcher3.PagedView.PageSwitchListener;
import com.gwchina.launcher3.allapps.AllAppsContainerView;
import com.gwchina.launcher3.allapps.DefaultAppSearchController;
...
import com.gwchina.launcher3.util.TestingUtils;
import com.gwchina.launcher3.util.Thunk;
import com.gwchina.launcher3.widget.PendingAddWidgetInfo;
import com.gwchina.launcher3.widget.WidgetHostViewLoader;
import com.gwchina.launcher3.widget.WidgetsContainerView;
...
public class Launcher extends Activity
    ...
    static final String INTENT_EXTRA_IGNORE_LAUNCH_ANIMATION =
            "com.gwchina.launcher3.intent.extra.shortcut.INGORE_LAUNCH_ANIMATION";
    ...
    static final String ACTION_FIRST_LOAD_COMPLETE =
            "com.gwchina.launcher3.action.FIRST_LOAD_COMPLETE";
    static final String ACTION_TIME_STRATEGY = "com.gwchina.launcher3.action.time_strategy";
...
//    }
    ...
    protected void onResume() {
        ...
        PermissionChecker.hasReadExternalStorage(this);
    }
...
//                return onSearchRequested();
    ...
    private void setupViews() {
        ...
        if (!mDeviceProfile.inv.isDisableAllApps) {
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            } else if (ACTION_TIME_STRATEGY.equals(action)) {
                long time = intent.getLongExtra("left_time", 0);
                mWorkspace.updateTimeStrategy(time);
            } else if (ThemeManager.ACTION_THEME_APPLIED.equals(action)) {
                if (!mRestoring) {
                    if (DISABLE_SYNCHRONOUS_BINDING_CURRENT_PAGE) {
                        // If the user leaves launcher, then we should just load items asynchronously when
                        // they return.
    ...
    public void onAttachedToWindow() {
        ...
        filter.addAction(ACTION_TIME_STRATEGY);
        filter.addAction(ThemeManager.ACTION_THEME_APPLIED);
    ...
    public void onClick(View v) {
        ...
        // TODO remove the test data open
        Object tag = v.getTag();
        if (tag instanceof ShortcutInfo) {
            ShortcutInfo info = (ShortcutInfo) tag;
            Log.e(TAG, info.intent.toString());
            ComponentName cn = info.intent.getComponent();
            boolean open = AppAuditHelper.audit(this, cn.getPackageName(), cn.getClassName());
            open = true;
            if (open) onClickAppShortcut(v);
            ...
            if(mAppsView != null) onClickAllAppsButton(v);
        } else if (tag instanceof AppInfo) {
            AppInfo info = (AppInfo) tag;
            boolean open = AppAuditHelper.audit(this, info.componentName.getPackageName(),
                    info.componentName.getClassName());
            open = true;
            if (open) startAppShortcutOrInfoActivity(v);
    ...
    public void openFolder(FolderIcon folderIcon) {
        ...
        // do not open an empty folder
        if (info.isEmptyFolder()) return;
    ...
    public boolean onLongClick(View v) {
        ...
        if (v.getTag() instanceof ItemInfo) {
            ...
            if (info.options == LauncherSettings.Favorites.OPTIONS_FIXED_ITEM) {
                return false;
            }
    ...
    public View getOrCreateQsbBar() {
        ...
        if (mQsb == null && mQsbContainer == null) {
    ...
    public void startBinding() {
        ...
        mWidgetsToAdvance.clear();
        if (mHotseat != null && mAppsView != null) {
            // we don't need All apps button when in No Drawer Mode
    ...
    public void finishBindingItems() {
        ...
        mWorkspace.startAnimQsbBlock(Workspace.State.NORMAL, LauncherAnimUtils.createAnimatorSet());
    ...
    public boolean isAllAppsButtonRank(int rank) {
        if (mHotseat != null && !mDeviceProfile.inv.isDisableAllApps) {
    ...
    interface DebugIntents {
        static final String DELETE_DATABASE = "com.gwchina.launcher3.action.DELETE_DATABASE";
        static final String MIGRATE_DATABASE = "com.gwchina.launcher3.action.MIGRATE_DATABASE";
    }
}
