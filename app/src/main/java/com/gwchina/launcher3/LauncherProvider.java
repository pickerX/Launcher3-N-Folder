...
import com.gwchina.launcher3.AutoInstallsLayout.LayoutParserCallback;
...
public class LauncherProvider extends ContentProvider {
    ...
    static final String TABLE_APP_TYPE = LauncherSettings.AppType.TABLE_NAME;
    ...
    @Thunk static long dbInsertAndCheck(DatabaseHelper helper,
        ...
        if (!table.equals(LauncherSettings.AppType.TABLE_NAME)) {
    ...
    protected static class DatabaseHelper extends SQLiteOpenHelper implements LayoutParserCallback {
        ...
        private void addAppTypeTable(SQLiteDatabase db, boolean optional) {
            String ifNotExists = optional ? " IF NOT EXISTS " : "";
            db.execSQL("CREATE TABLE " + ifNotExists + TABLE_APP_TYPE + " (" +
                    LauncherSettings.AppType.ID + " INTEGER PRIMARY KEY AUTOINCREMENT," +
                    LauncherSettings.AppType.APP_TYPE + " TEXT," +
                    LauncherSettings.AppType.PACKAGE_NAME + " TEXT," +
                    LauncherSettings.AppType.CLASS_NAME + " TEXT," +
                    LauncherSettings.AppType.TITLE + " TEXT," +
                    LauncherSettings.AppType.MODIFIED + " INTEGER NOT NULL DEFAULT 0," +
                    LauncherSettings.AppType.ITEM_TYPE + " INTEGER NOT NULL DEFAULT " +
                    LauncherSettings.AppType.ITEM_TYPE_APP +
                    ");");
        }
