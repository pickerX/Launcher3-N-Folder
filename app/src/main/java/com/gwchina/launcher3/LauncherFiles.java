...
public class LauncherFiles {
    ...
    public static final String SHARED_PREFERENCES_KEY = "com.gwchina.launcher3.prefs";
    public static final String WALLPAPER_CROP_PREFERENCES_KEY =
            "com.gwchina.launcher3.WallpaperCropActivity";
    public static final String MANAGED_USER_PREFERENCES_KEY = "com.gwchina.launcher3.managedusers.prefs";
    ...
    public static final List<String> OBSOLETE_FILES = Collections.unmodifiableList(Arrays.asList(
            ...
            "com.gwchina.launcher3.compat.PackageInstallerCompatV16.queue"));
}
