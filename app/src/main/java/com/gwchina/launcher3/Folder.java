...
import com.gwchina.launcher3.CellLayout.CellInfo;
...
public class Folder extends LinearLayout implements DragSource, View.OnClickListener,
    ...
    public boolean onLongClick(View v) {
        ...
        if (isFixedFolder()) return true;
        return beginDrag(v, false);
    }

    public boolean isFixedFolder() {
        if (mInfo == null) return false;
        return mInfo.options == LauncherSettings.Favorites.OPTIONS_FIXED_ITEM;
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int contentAreaWidthSpec = MeasureSpec.makeMeasureSpec(contentWidth, MeasureSpec.AT_MOST);
        int contentAreaHeightSpec = MeasureSpec.makeMeasureSpec(contentHeight, MeasureSpec.AT_MOST);

        mContent.setFixedSize(getContentAreaWidth(), this.mContent.getDesiredHeight());
    ...
    void replaceFolderWithFinalItem() {
        // check folder is fixed folder
        if (mInfo.options == FolderInfo.FLAG_FIXED_FOLDER) {
            return;
        }
