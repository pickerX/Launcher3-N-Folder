...
public abstract class Qsb extends FrameLayout implements View.OnClickListener {
    ...
    private void startQsbActivity(String str) { //bl
        try {
            getContext().startActivity(new Intent(str).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK
                    | Intent.FLAG_ACTIVITY_NEW_TASK).setPackage("com.google.android.googlequicksearchbox"));
    ...
    private void applyVisibility() { //bg
        int visibility = PackageManagerHelper.isAppEnabled(getContext().getPackageManager(),
                "com.google.android.googlequicksearchbox") ? View.VISIBLE : View.GONE;
