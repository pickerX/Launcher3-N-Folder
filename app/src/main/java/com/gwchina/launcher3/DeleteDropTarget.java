...
import com.gwchina.launcher3.util.FlingAnimation;
...
public class DeleteDropTarget extends ButtonDropTarget {
    ...
    /**
     * only LauncherSettings.Favorites.ITEM_TYPE_SHORTCUT itemInfo,LauncherAppWidgetInfo and FolderInfo
     * can support delete action when in disableAllApps mode
     * @param info
     * @return
     */
    public static boolean supportsDrop(Object info) {
        boolean supportDrop = (info instanceof ShortcutInfo) || (info instanceof LauncherAppWidgetInfo)
        ...
        if(info instanceof ShortcutInfo) {
            ...
            if (LauncherAppState.getInstance().getInvariantDeviceProfile()
                    .isDisableAllApps) {
                supportDrop = shortcutInfo.itemType == LauncherSettings.Favorites.ITEM_TYPE_SHORTCUT;
            }
        }
